...
declare -a arr=(
# "p02rmPFmxE4miL65p04mxTs300pID55p06upm0.5lom2" 
# "p02rmPFmxE4miL65p04mxTs300pID60p06upm0.5lom2" 
# "p02rmPFmxE4miL65p04mxTs300pID65p06upm0.5lom2" 
# "p02rmPFmxE4miL65p04mxTs300pID70p06upm0.5lom2" 
# "p02rmPFmxE4miL65p04mxTs300pID75p06upm0.5lom2" 
# "p02rmPFmxE4miL65p04mxTs300pID80p06upm0.5lom2" 
# "p02rmPFmxE4miL65p04mxTs300pID85p06upm0.5lom2" 
# "p02rmPFmxE4miL65p04mxTs300pID90p06upm0.5lom2" 
...
do
   ...
   #mv "AMRH_MBIBAL_1-demultiplexed" "$NWDIR" 
   #mv "${INP1}" "${NWDIR}" 
   ...
   #cat part02_dada2_sickle_v2_start_swk_AMRH_AL.r | sed "s/fpfml <- 65/fpfml <- $NWNM/g" > tmp01.txt
...
do
   ...
   #modify the part02 R code for the maxEE value
   #cat part02_dada2_sickle_v2_start_swk_AMRH_AL.r | sed "s/mxEEval=4/mxEEval=$NWNM/g" > tmp01.txt
   #cat part04_run_02blast_global_AMRH_AL.sh | sed "s/-perc_identity 80/-perc_identity $NWNM/g" > tmp01.txt
   #rename the file
   #mv tmp01.txt part04_run_02blast_global_AMRH_AL.sh
   #modify permission on the copied file
