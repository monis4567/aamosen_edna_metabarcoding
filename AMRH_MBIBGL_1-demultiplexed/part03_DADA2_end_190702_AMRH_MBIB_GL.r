...
YOUR_LIB_1 <- "/groups/hologenomics/phq599/data/AMRH_MBIBGL_1-demultiplexed"
...
YOUR_LIB_2 <- "/groups/hologenomics/phq599/data/AMRH_MBIBHL_1-demultiplexed"
#define paths to your libraries
...
YOUR_LIB_3 <- "/groups/hologenomics/phq599/data/AMRH_MBIBIL_1-demultiplexed"
#define paths to your libraries
...
YOUR_LIB_4 <- "/groups/hologenomics/phq599/data/AMRH_MBIBJL_1-demultiplexed"
#define paths to your libraries
