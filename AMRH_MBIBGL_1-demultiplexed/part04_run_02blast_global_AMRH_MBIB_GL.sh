...
OUTFLN1="blast_result_AMRH_MBIB_GL.results.01.txt"
OUTFLN2="AMRH_MBIB_GL.DADA2_nochim.otus.fas"
...
blastn -db nt -max_target_seqs 100 -outfmt "6 std qlen qcovs sgi sseq ssciname staxid" -out "${OUTFLN1}" -qcov_hsp_perc 90 -perc_identity 80 -query "${INPFNM1}"
