...
inp_fn1 <- "part04_blast_result_AMRH_MBIB_BL.results.01_l20_q08.txt"
...
outp_fn1="part05_blast_result_AMRH_MBIB_BL.results.02_l20_q08.txt"
  ###Get packages
...
#define a filename to write out to
#outp_fn1="part05_blast_result_AMRH_MBIB_GL.results.02.txt"
#write a file with possibel species names
write.table(raw_blast_results02, outp_fn1, 
