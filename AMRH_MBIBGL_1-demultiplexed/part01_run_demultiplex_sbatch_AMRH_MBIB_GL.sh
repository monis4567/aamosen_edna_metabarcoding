...
## Activating the shell script: 'part01_dada2_demultiplexing_v2_AMRH_MBIB_GL.sh'  
## will call upon two additional files as input files for the demultiplex process.
## In this case these files are :
## "part01_batchfileDADA2_AMRH_MBIB_GL.list"
## and
## "part01_tags_AMRH_MifishU_PCR21.txt"
## Make sure these files also are available in the same directory as where you place
## the file 'part01_dada2_demultiplexing_v2_AMRH_MBIB_GL.sh'
...
./part01_dada2_demultiplexing_v2_AMRH_MBIB_GL.sh