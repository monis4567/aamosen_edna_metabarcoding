...
# define input batchfile that holds paths to raw NGS metabarcode read
# the name of the tags.txt file and the primer sequence and a number for the
# minimum read length
BATCHF="part01_batchfileDADA2_AMRH_MBIB_GL.list"

# deletes any previous versions of these directories
rm -rf DADA2_* 
mkdir DADA2_AS
mkdir DADA2_SS
