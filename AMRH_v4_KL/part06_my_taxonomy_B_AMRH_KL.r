...
inputfilenm2="part05_blast_AMRH_KL.results.02.txt"

#define output file names 
outputfilenm1="part06_my_classified_otus_AMRH_KL.01.unfilt_BLAST_results.txt"
outputfilenm2="part06_my_classified_otus_AMRH_KL.02.filt_BLAST_results.txt"
