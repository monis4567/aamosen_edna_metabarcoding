...
#SBATCH -o stdout_part01_demulplex.txt
#SBATCH -e stderr_part01_demulplex.txt


## Activating the shell script: 'part01_dada2_demultiplexing_v2_AMRH_MBIB_AL.sh'  
## will call upon two additional files as input files for the demultiplex process.
## In this case these files are :
## "part01_batchfileDADA2_AMRH_MBIB_AL.list"
## and
## "part01_tags_AMRH_MBIB_A_Mamm01_PCR37.txt"
## Make sure these files also are available in the same directory as where you place
## the file 'part01_dada2_demultiplexing_v2_AMRH_MBIB_AL.sh'
...
./part01_dada2_demultiplexing_v2_AMRH_MBIB_CL.sh
