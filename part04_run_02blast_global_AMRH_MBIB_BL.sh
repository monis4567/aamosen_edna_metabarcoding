...
#SBATCH -o stdout_pa04_blast_global.txt
#SBATCH -e stderr_pa04_blast_global.txt
...
OUTFLN1="part04_blast_result_AMRH_MBIB_BL.results.01.txt"
OUTFLN2="AMRH_MBIB_BL.DADA2_nochim.otus.fas"
...
blastn -db nt -max_target_seqs 300 -outfmt "6 std qlen qcovs sgi sseq ssciname staxid" -out "${OUTFLN1}" -qcov_hsp_perc 90 -perc_identity 80 -query "${INPFNM1}"
